...
public class Logic
    ...
    public static float rightTriangleArea(double mLength, double mWidth) {
        return (float)(0.5*mLength*mWidth);
    }

    public static float rightTrianglePerimeter(double mLength, double mWidth) {
        return (float)(mLength+mWidth+Math.sqrt(Math.pow(mLength,2)+Math.pow(mWidth,2)));

    }

    public static float circleArea(double mRadius) {
        return (float)(Math.PI*Math.pow(mRadius,2));

    }

    public static float circleCircumference(double mRadius) {
        return (float)(2*Math.PI*mRadius);
    }

    public static float sphereSurfaceArea(double mRadius) {
        return (float)(4*Math.PI*Math.pow(mRadius,2));
    }

    public static float sphereVolume(double mRadius) {
        return (float)((4*Math.PI*Math.pow(mRadius,3))/3);
    }

    public static float rectangleArea(double mLength, double mWidth) {
        return (float)(mLength*mWidth);
    }

    public static float rectanglePerimeter(double mLength, double mWidth) {
        return (float)(2*(mLength+mWidth));
    }

    public static float boxSurfaceArea(double mLength, double mWidth, double mHeight) {
        return (float)(2*(mHeight*mLength + mLength*mWidth + mWidth*mHeight));
    }

    public static float boxVolume(double mLength, double mWidth, double mHeight) {
        return (float)(mHeight*mLength*mWidth);
    }
